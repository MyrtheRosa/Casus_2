...
<template>
  <nav
    :class="[
      ...
      props.solid || isScrolled ? 'bg-[#1f1f1f] text-white shadow-md' : 'bg-transparent text-white'
    ]"
  >
    <!-- Logo -->
    ...
    <div class="lg:hidden relative z-[60]">
      <button
        ...
        type="button"
        class="inline-flex items-center justify-center rounded-md p-2 text-white focus:outline-none focus:ring-2 focus:ring-white"
      >
        <svg v-if="!mobileMenuOpen" xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="none"
    ...
    <transition name="slide">
      ...
      >
        ...
        <a href="#" @click="toggleMobileMenu">Diensten</a>
...
<style scoped>
/* Dubbele lijn-animatie bij hover */
.menu-item {
  position: relative;
  padding: 0.25rem 0;
