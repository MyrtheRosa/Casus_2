  ...
  <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
    ...
    <div class="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
      <a href="#" class="group">
        ...
        <h3 class="mt-4 text-sm text-gray-700">aaa</h3>
        <p class="mt-1 text-lg font-medium text-gray-900">bbb</p>
      </a>
      <a href="#" class="group">
        ...
        <h3 class="mt-4 text-sm text-gray-700">ccccc</h3>
        <p class="mt-1 text-lg font-medium text-gray-900">ddddd</p>
      </a>
      <a href="#" class="group">
        ...
        <h3 class="mt-4 text-sm text-gray-700">eeeee</h3>
        <p class="mt-1 text-lg font-medium text-gray-900">fffff</p>
      </a>
      <a href="#" class="group">
        ...
        <h3 class="mt-4 text-sm text-gray-700">gggggggg</h3>
        <p class="mt-1 text-lg font-medium text-gray-900">hhhhhhh</p>
      </a>
